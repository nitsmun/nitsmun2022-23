                    ...
                    <div className="ntsmn23-rl-cont">
                        <div className="agnd">
                            ...
                            <div className="comt-txt-imp">
                                <h2>Presenting to you, our first committee and also the one we are particularly the most thrilled for and for which we wish you would be equally excited, The International Confederation of Wizards!</h2>
                            </div>
                        </div>
                        <div className="agnd">
                            <div className="img-nts23">
                            ...
                            <div className="comt-txt-imp">
                                <h2>Presenting to you our third Committee :North Atlantic Treaty Organzation( NATO): The NATO having been established in 1949 has since been serving its task of protecting the states of Europe, facilitate cooperation among states and secure peace in the continent.</h2>
                            </div>
                        </div>
                        <div className="agnd">
                            <div className="img-nts23">
                            ...
                            <div className="comt-txt-imp">
                                <h2>Our second committee is for all the journalism enthusiasts out there, the International Press Corps.</h2>
                            </div>
                        </div>
                    </div>
                </div>
