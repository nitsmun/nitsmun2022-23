  ...
  return (
    <div style={{background : "rgba(137, 255, 230, 0.2)"}}>
      ...
      <div className="nm22-agenda">
       <div className="nm22-agendaimgcon1"> <img src="./Images/UNSCbg12022.jpg" alt="NITSMUN 2022" className="nm22-agendaimg1" /></div>
        <div className="nm22-agendaimgcon1"><img src="./Images/UNEPbg12022.jpg" alt="NITSMUN 2022" className="nm22-agendaimg1" /></div>
      </div>
        <div className="nm222-agendaimgcon2"><img src="./Images/international_press.jpg" alt="NITSMUN 2022"  className="nm22-agendaimg2"/></div>
        <br />
        <br />
    ...
    <div className="nm22-exemain">
      <div className="nm22-exmainhead" ><h1>Executive Board</h1><Underline/></div>
