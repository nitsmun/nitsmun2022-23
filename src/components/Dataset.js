...
export const apply = [
  ...
  },
  {
    ...
    msg: (
      <>
        <a
          href="https://forms.gle/git2MsU3cY1TJSGM9"
          className="apply-redirect p-by"
          target="_blank"
          rel="noreferrer"
        >
          Click here to Register in Photo Journalism - International Press Corps
          (IPC) 2023.
          <svg
            viewBox="0 0 24 24"
            fill="none"
