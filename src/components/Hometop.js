  ...
  return (
    <div style={{ userSelect: "none" }}>
      <div className="hometop-main">
        <a href="https://incand.in" target="_blank" rel="norefferer noreferrer">
